...
<body>
    ...
    <br>
    <input type="button" value="목록보기" onclick="location.href='News.php'">
    <input type="button" value="수정" onclick="location.href='News_write.php?num=<?= $num ?>'">
    <input type="button" value="삭제" onclick="location.href='News_delete.php?num=<?= $num ?>'">
    <div class="search">
