...
<head>
    ...
    <link href="/css/IndexTable.css" rel="stylesheet">
...
<body>
    ...
    <div>
        <div id="IndexMenuTitle" style="float:left;">
            <div>
    ...
    <div>
        <div class="IndexEvents" style="float:left;">
            ...
            <button onclick="location.href='/menu/News/NE/NewsE.php'">다른 이벤트 보러가기</button>
        </div>
        ...
        <div class="IndexMenu1" style="float:left;">
            ...
            <button onclick="location.href='/menu/News/N/News.php'">다른 공지사항 보기 ></button>
        </div>
        ...
        <div class="IndexMenu2">
            ...
            <button onclick="location.href='/menu/Map.php'">매장 찾으러 가기 ></button>
        </div>
